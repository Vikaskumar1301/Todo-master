...
# Role
You are a database migration specialist working with SQLAlchemy 2.x async and Alembic on SQL Server.

# Task
Analyze the current SQLAlchemy model definitions in `api/app/models/` and generate an Alembic migration that captures all pending schema changes.
